...
table.refreshFtpSummary = function( o,filters, args ) {
 ...
 var t = [], 
  ...
  forecastrow.cells[0].firstChild.nodeValue = t[6].toFixed(2);
  forecastrow.cells[1].firstChild.nodeValue = t[7].toFixed(2);
  forecastrow.cells[2].firstChild.nodeValue = (t[7] - t[6]).toFixed(2);
